...
CellProfiler 3.1.8 version is used (Documentation: ). 
All scripts are developed for the "bigpurple" computing cluster of the NYU Grossman School of Medicine and appropriate SLURMP headers are used in the .sh scripts. 
...
## Pipeline
Our CellProfiler pipeline consists of the following steps (Please, see CellProfiler 3.1.8 documentation for more details, at ):
